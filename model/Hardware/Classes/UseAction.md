...
For each `UseAction` there is at least one `/Core/Relationship` class or subclass with the relationshipType of 'effected’ on the from and a `/Core/Element` class or subclass on the to.
